...
class NewModel(object):
    ...
    def hessian_entropy(self):
        ...
        hess_S_t = ((1. - self.n_sites/self.gamma)
                    * hess_S_i + (self.n_sites/self.gamma) * hess_S_n)
    ...
    def partial_molar_entropies(self):
        ...
        g_S_t = ((1. - self.n_sites/self.gamma) * g_S_i
                 + (self.n_sites/self.gamma) * g_S_n)
    ...
    def molar_entropy(self):
        ...
        S_t = ((1. - self.n_sites/self.gamma) * S_i
               + (self.n_sites/self.gamma) * S_n)
